...
proc_block: BEGIN
    ...
    ELSEIF v_role_name <> 'admin' THEN
        SET v_error_msg = 'Access denied. Only admin can delete books. ';
    END IF;
    ...
    -- Delete book (copies auto delete because CASCADE)
    DELETE FROM books
    WHERE book_id = p_book_id;

    SELECT 'Book and all its copies deleted successfully.' AS message;
